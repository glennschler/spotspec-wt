...
const AwsSpotter = require('./awsspotter.js').AwsSpotter
const Const = require('./awsspotter.js').Const
const Intern = require('./awsspotter.js').Intern
...
module.exports = function (context, cb) {
  ...
  // If AWS service will use a MFA Token, the serualNumber was sent as a secret
